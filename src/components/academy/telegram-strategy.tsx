    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-[#f6f6f6] p-5 md:p-6">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {strategy.chatTypes.map((chat) => (
            <span key={chat} className="rounded-lg bg-white px-3 py-1.5 text-xs text-[#050505]">
              {chat}
            </span>
          ))}
        </div>
        ...
        <div className="rounded-2xl bg-[#f6f6f6] p-5">
          ...
          <ul className="mt-3 space-y-1.5">
            {strategy.dos.map((item) => (
              <li key={item} className="text-sm text-[#050505]">· {item}</li>
            ))}
          </ul>
        </div>
        <div className="rounded-2xl bg-[#f6f6f6] p-5">
      ...
      <div className="space-y-4">
        {[
          ...
          <div key={item.label} className="rounded-2xl bg-[#f6f6f6] p-5">
