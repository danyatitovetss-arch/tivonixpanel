  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      {templates.map((template, i) => (
        <div key={template.id} className="flex flex-col rounded-2xl bg-[#f6f6f6] p-5">
          <div className="flex items-start gap-3">
            <span className="flex size-7 shrink-0 items-center justify-center rounded-full bg-white text-xs font-semibold text-[#050505]">
              {i + 1}
            </span>
